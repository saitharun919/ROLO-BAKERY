...
const Body = () => {
  return (
    <div className='body'>
        ...
        <h1 className='font-heading'>Our Promise</h1>
        </div>
       ...
       <div className='content'>
        ...
        <span>a beautifully hand piped message of your choice to add a little personal touch.</span>
        <span>It is our mission to make every celebration a piece of cake.</span> 
       </div>
    </div>
  )
}
